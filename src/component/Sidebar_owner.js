        ...
        <div className={css.container_bar}>
          <div className="d-flex flex-column align-items-start w-100 ps-3 gap-2">
            ...
            {profile.role === "owner" ? (
              <button
                className={
                  page === "profileowner" ? css.profile_active : css.profile
                }
              ...
              <button
                className={
                  page === "profileadmin" ? css.profile_active : css.profile
                }
                onClick={() => navigate("/datauseradmin")}
              >
                <i className="fa-solid fa-user"></i>
                <p>Data Account</p>
              </button>
            ...
            {profile.role === "owner" ? (
              <button
                className={
                  page === "datakontrakanowner"
                    ? css.kontrakan_active
                    : css.kontrakan
                }
                onClick={() => navigate("/kontrakanowner")}
              >
            ...
            {profile.role === "owner" ? (
              <button
                className={
                  page === "datapemesananowner"
                    ? css.pemesanan_active
                    : css.pemesanan
                }
                onClick={() => navigate("/KontrakanPemesananOwner")}
              >
